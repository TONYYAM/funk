...
import com.yjl.funk.audiocache.file.MusicFileNameGenerator;
import com.yjl.funk.audiocache.file.TotalCountLruDiskUsage;
import com.yjl.funk.audiocache.file.TotalSizeLruDiskUsage;
import com.yjl.funk.audiocache.headers.EmptyHeadersInjector;
...
import static com.yjl.funk.audiocache.Preconditions.checkAllNotNull;
...
public class HttpProxyCacheServer {
     ...
     * <p>
     * If file for this url is fully cached (it means method {@link #} returns {@code true})
     * then file:// uri to cached file will be returned.
     * <p>
     * Calling this method has same effect as calling {@link (String, boolean)} with 2nd parameter set to {@code true}.
     *
     ...
     */
    public String getProxyUrl(String url,MusicTrack track) {
     ...
     * (it means method {@link #} returns {@code true}) then file:// uri to cached file will be returned.
     *
     * @param url                a url to file that should be cached.
    ...
    public String getProxyUrl(String url, boolean allowCachedFileUri) {
        if (track!=null&&allowCachedFileUri && isCached(track)) {
            File cacheFile = getCacheFile(track);
    ...
    public boolean isCached(MusicTrack track) {
        return getCacheFile(track).exists();
    }
    ...
    private File getCacheFile(MusicTrack track) {
        File cacheDir = config.cacheRoot;
        String fileName = config.fileNameGenerator.generate(track);
    ...
    private HttpProxyCacheServerClients getClients(String url) throws ProxyCacheException {
        synchronized (clientsLock) {
            ...
            if (clients == null) {
                if(track!=null)
                clients = new HttpProxyCacheServerClients(track,url, config);
    ...
    public static final class Builder {
        ...
        public Builder(Context context) {
            ...
            this.fileNameGenerator = new MusicFileNameGenerator();
        ...
        /**
         * Overrides default cache file name generator {@link MusicFileNameGenerator} .
         *
