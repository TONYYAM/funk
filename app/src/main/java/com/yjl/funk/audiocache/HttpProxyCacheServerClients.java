...
import com.yjl.funk.audiocache.file.FileCache;
...
final class HttpProxyCacheServerClients {
    ...
    public HttpProxyCacheServerClients(MusicTrack track,String url, Config config) {
    ...
    private HttpProxyCache newHttpProxyCache() throws ProxyCacheException {
        ...
        FileCache cache = new FileCache(config.generateCacheFile(track), config.diskUsage);
