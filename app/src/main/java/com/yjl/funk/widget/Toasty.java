...
public class Toasty {
    ...
    @ColorInt
    private static int ERROR_COLOR = Color.parseColor("#FF5E5A");
    @ColorInt
    private static int INFO_COLOR = Color.parseColor("#1AC0AF");
    @ColorInt
    private static int SUCCESS_COLOR = Color.parseColor("#1AC0AF");
    @ColorInt
    ...
    public static Toast custom(@NonNull Context context, @NonNull CharSequence message, Drawable icon,
        ...
        currentToast.setGravity(Gravity.BOTTOM,0, DensityUtils.dip2px(context,130));
        return currentToast;
    }
